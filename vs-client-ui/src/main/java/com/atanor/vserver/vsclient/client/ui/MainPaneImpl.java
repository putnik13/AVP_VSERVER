...
import com.atanor.vserver.vsclient.client.ui.widgets.BackgroundCanvas;
...
public class MainPaneImpl extends HLayout implements MainPane {
	...
	private final BackgroundCanvas sessionInactiveLayer;
	...
	public MainPaneImpl() {
		...
		sessionInactiveLayer = new BackgroundCanvas();
	...
	public void onSessionStart() {
		sessionInactiveLayer.sessionStart();
