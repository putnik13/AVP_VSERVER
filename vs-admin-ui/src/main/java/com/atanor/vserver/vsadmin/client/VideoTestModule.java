...
import com.videojs.client.VideoPlayerHandler;

/**
 * Entry point classes define <code>onModuleLoad()</code>.
 */
public class VideoTestModule implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        //player screen 320x240
        //videoUrl.setValue("http://video-js.zencoder.com/oceans-clip.mp4");
        videoUrl.setValue("http://localhost:8080/recordings/oceans-clip.mp4");
